...
<section class="ftco-section ftco-no-pt ftco-no-pb bg-primary">
    <div class="container py-4">
        ...
        <div class="col-md-7 ftco-animate d-flex align-items-center">
            <h2 class="mb-0" style="color:white; font-size: 28px;">Pilih wisata sesukamu</h2>
        </div>
        <div class="col-md-5 d-flex align-items-center">
            <div class="form-group d-flex">
                <input type="text" class="form-control" id="search-wisata" placeholder="Cari wisata atau kota">
                <button onclick="searchWisata()" value="Search" class="submit px-3">Search</button>
            </div>
        </div>
        </div>
    </div>
...
<section>
    <div class="container mt-3">
        ...
        <button onclick="searchTag('{{$jenis->jenis_wisata}}')" class="btn btn-secondary">
            {{$jenis->jenis_wisata}}
        </button>
        @endforeach
    </div>
...
<section class="ftco-section bg-light">
    <div class="container" id="search-result">
        ...
        <div class="row d-flex" id="wisatas-search">
    </div>
    </div>
    <div class="container">
